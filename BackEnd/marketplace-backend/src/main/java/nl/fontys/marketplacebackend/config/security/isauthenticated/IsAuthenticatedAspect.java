package nl.fontys.marketplacebackend.config.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(nl.fontys.marketplacebackend.config.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
        //SpringBoot already handles the method
    }

    @Pointcut("@within(nl.fontys.marketplacebackend.config.security.isauthenticated.IsAuthenticated)")
